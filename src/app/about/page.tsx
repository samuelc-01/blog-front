    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-8">
        ...
        <div className="flex-grow">
          <h1 className="text-2xl font-bold text-black mb-2">Samuel Cristian</h1>
          <p className="text-gray-600 mb-4">@samuelc-01</p>
          
          <div className="flex items-center gap-4 mb-4">
            <Link 
              href="https://github.com/samuelc-01" 
              target="_blank"
            ...
            <Link 
              href="https://www.linkedin.com/in/samuel-cristian" 
              target="_blank"
              className="text-black hover:text-gray-700 font-medium"
            >
              <span className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <span className="flex items-center gap-1">
              ...
              samuel.cristian17062004@gmail.com
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="text-gray-600">Tecnologias Principais</div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            "C++", "Arduino", "Electronics", "Git", "Linux"
          ].map((skill) => (
            <span 
              key={skill}
